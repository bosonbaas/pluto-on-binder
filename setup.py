...
import os
os.system('julia -e "import Pkg; Pkg.activate("home/jovyan"); Pkg.add([\\"DataFrames\\", \\"XLSX\\", \\"CSV\\", \\"Plots\\", \\"DifferentialEquations\\", \\"LabelledArrays\\", \\"PlutoUI\\", \\"Catlab\\", \\"Colors\\", \\"AlgebraicPetri\\", \\"CSV\\", \\"DataFrames\\", \\"JSON\\", \\"Distributions\\"]); Pkg.precompile()"')
